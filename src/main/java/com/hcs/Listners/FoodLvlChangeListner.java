...
public class FoodLvlChangeListner implements Listener
{
	...
	private final static int FOOD_SKIP = 4; // For every FOOD_SKIP times it
											// tries to decrease the health it
											// will actually be decreased
	private final static float FOOD_SAT_ADD = 0.2F; // the food saturation to
													// add when failed to loose
													// hunger
