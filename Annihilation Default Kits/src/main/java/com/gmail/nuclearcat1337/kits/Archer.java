...
public class Archer extends KitBase
{
	...
	protected List<String> getDefaultDescription()
	{
		...
		addToList(l, aqua + "You are the rain.", "", aqua + "Obliterate your enemies", aqua + "from a distance.", "",
				aqua + "You deal +1 damage with", aqua + "any bow and you have the", aqua + "ability to create arrows",
				aqua + "from flint and stucks.", "", aqua + "Just put a flint on top", aqua + "of a stick in your crafting",
				aqua + "interface to create 3", aqua + "arrows!");
		return l;
	}
	...
	protected Loadout getFinalLoadout()
	{
		return new Loadout().addWoodSword().addWoodPick().addWoodAxe().addWoodShovel()
				.addSoulboundEnchantedItem(new ItemStack(Material.BOW), Enchantment.ARROW_DAMAGE, 1)
