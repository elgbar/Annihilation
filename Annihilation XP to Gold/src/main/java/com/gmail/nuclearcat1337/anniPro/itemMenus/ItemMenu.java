...
public class ItemMenu
{
	...
	/**
	 * The {@link com.gmail.nuclearcat1337.anniPro.itemMenus.StaticMenuItem} that appears in empty slots if
	 * {@link com.gmail.nuclearcat1337.anniPro.itemMenus.MenuItem#fillEmptySlots()} is called.
	 */
	 ...
	 * @param size
	 *            The {@link com.gmail.nuclearcat1337.itemMenu.Size} of the inventory.
	 * @param parent
	 ...
	 *            The name of the inventory.
	 * @param size
	 *            The {@link com.gmail.nuclearcat1337.anniPro.itemMenus.MenuItem.Size} of the inventory.
	 * @param plugin
	 *            The Plugin instance.
	 */
	...
	/**
	 * Gets the {@link com.gmail.nuclearcat1337.anniPro.itemMenus.MenuItem.Size} of the {@link com.gmail.nuclearcat1337.anniPro.itemMenus.MenuItem}.
	 *
	 * @return The {@link com.gmail.nuclearcat1337.anniPro.itemMenus.MenuItem}'s {@link com.gmail.nuclearcat1337.anniPro.itemMenus.MenuItem.Size}.
	 */
	public Size getSize ()
	{
		return size;
	 ...
	 *
	 * @return True if the {@link com.gmail.nuclearcat1337.anniPro.itemMenus.MenuItem} has a parent, else false.
	 */
	...
	/**
	 * Fills all empty slots in the {@link com.gmail.nuclearcat1337.anniPro.itemMenus.MenuItem} with a certain
	...
	/**
	 * Fills all empty slots in the {@link com.gmail.nuclearcat1337.anniPro.itemMenus.MenuItem} with the default empty slot item.
	 *
	 * @return The {@link com.gmail.nuclearcat1337.anniPro.itemMenus.MenuItem}.
	 */
	...
	{
		if (!ItemMenuListener.getInstance ().isRegistered (XP2GMain.getInstance ()))
		{
			ItemMenuListener.getInstance ().register (XP2GMain.getInstance ());
		}

		Inventory inventory = Bukkit.createInventory (new ItemMenuHolder (this, Bukkit.createInventory (player, size.getSize ())), size.getSize (),
				name);
	 ...
	 *
	 * @param player
	 *            The player to update the {@link com.gmail.nuclearcat1337.anniPro.itemMenus.MenuItem} for.
	 */
	...
	/**
	 * Applies the {@link com.gmail.nuclearcat1337.anniPro.itemMenus.MenuItem} for a player to an Inventory.
	 *
	 * @param inventory
	 *            The Inventory.
	 * @param player
	...
	/** Handles InventoryClickEvents for the {@link com.gmail.nuclearcat1337.anniPro.itemMenus.MenuItem}. */
	...
	public enum Size
	{
		...
		/**
		 * Gets the {@link com.gmail.nuclearcat1337.anniPro.itemMenus.MenuItem.Size}'s amount of slots.
		 *
		...
		/**
		 * Gets the required {@link com.gmail.nuclearcat1337.anniPro.itemMenus.MenuItem.Size} for an amount of slots.
		 *
		 * @param slots
		 *            The amount of slots.
